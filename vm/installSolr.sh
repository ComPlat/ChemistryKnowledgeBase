...
sudo mv /home/vagrant/powersearch-2.4.1.zip /opt/powersearch
cd /opt/powersearch
sudo unzip powersearch-2.4.1.zip
sudo unzip solr-9.1.0.zip
sudo chmod +x install_solr_service.sh
sudo ./install_solr_service.sh solr-9.1.0.zip
