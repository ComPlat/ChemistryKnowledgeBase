...
<a title="{{$fullPageTitle}}" target="_blank" href="{{$url}}"><img class="chemform" src="{{$imageAlreadyRendered ? $imageURL : $placeHolderImg}}" width="{{$width}}" resource="{{base64_encode($molOrRxn)}}" height="{{$height}}"/></a>
