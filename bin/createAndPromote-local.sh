...
php $MEDIAWIKI/maintenance/createAndPromote.php --sysop --bureaucrat            --force 'Administrator'   'root22root'
php $MEDIAWIKI/maintenance/createAndPromote.php --bureaucrat                    --force 'Bureaucrat'      'root22root'

php $MEDIAWIKI/maintenance/createAndPromote.php --sysop --bureaucrat            --force 'WikiSysop'       'root22root'
